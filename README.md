...
<p>WIP changes -  versioning to 3.0.(.0) <br>
  This is a major release, currently very much a work-in-progress.. 
  <ul>
    ...
    <li>All project can use the h2 and MySQL database (enable quick start-up for demo and learning)</li>       
...
<p>Significant changes elease 2.2(.0)
  <ul>
