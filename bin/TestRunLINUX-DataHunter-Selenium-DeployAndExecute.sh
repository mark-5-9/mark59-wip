...
#     |        (not necessary before running this bat file - it runs the DataHunterSeleniumTestPlan which doesn't use the spreadsheet).
#     |
...
#     |
#     |  The only database considerations are that when the test is running server metrics are obtained invoking the 'localhost' profile  from the running
...
#     |
#     |  logging at  C:\apache-jmeter\bin\jmeter.log
#     |  JMeter result file output to C:\Mark59_Runs\Jmeter_Reports\DataHunter
#     |
#     -------------------------------------------------------------------------------------------------------------------------------------------------
