#   |------------------------------------------------------------------------------------------------------------------------------------------------
#   |  Use this file to copy artifacts from  Eclipse build target after Maven builds have been executed on the dataHunterPVtest and mark59-server-metrics projects,
#   |  into the target Jmeter instance  
#   | 
