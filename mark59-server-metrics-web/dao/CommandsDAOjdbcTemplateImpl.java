...
import com.mark59.servermetric.data.beans.Command;
...
public class CommandsDAOjdbcTemplateImpl implements CommandsDAO 
{
	...
	public Command findCommand(String commandName){
		...
		String selectServerSQL   = "select COMMAND_NAME, EXECUTOR, COMMAND, COMMENT "
				+ "from command where COMMAND_NAME = '" + commandName + "'"
...
//			System.out.println("CommandsDAOjdbcTemplateImpl.findCommands  : " + command.toString()  ) ;		
	...
	private String getCommandListSelectionSQL(String selectionCol, String selectionValue){	
		String commandListSelectionSQL = "select COMMAND_NAME, EXECUTOR, COMMAND, COMMENT from command ";
	...
	public void insertCommand(Command command) {
		...
		String sql = "INSERT INTO command ( COMMAND_NAME, EXECUTOR, COMMAND, COMMENT ) " + 
				      " VALUES (?,?,?,?)";
	...
	public void updateCommand(Command command){
		...
		String sql = "UPDATE command EXECUTOR = ?, COMMAND = ?, COMMENT = ? "
				+ "where COMMAND_NAME = ? ";
	...
	public void deleteCommand(String commandName) {
		...
		//set delets
		String sql = "delete from command where COMMAND_NAME ='" + commandName	+ "'";
