...
//----		
//		additionalTestParametersMap.put(NEW_RELIC_API_URL,		"https://api.newrelic.com/v2/applications/" );		
		additionalTestParametersMap.put(NEW_RELIC_API_APP_ID, 	"204442650");
		additionalTestParametersMap.put(NEW_RELIC_XAPIKEY, 		"87fe3f644a97fa74d1d6fde0460debd6f41c6556cd2e51d");
		additionalTestParametersMap.put(PROXY_SERVER, 			"proxy.auiag.corp");	
		additionalTestParametersMap.put(PROXY_PORT, 			"8080");			
//----		
